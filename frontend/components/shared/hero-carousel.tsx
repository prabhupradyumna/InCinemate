          ...
          <SwiperSlide key={m.id}>
            <div className="slide-content w-full h-full">
              <div className="relative w-full h-full">
                <Image
                  src={
                    m.backdrop_url || m.poster_url || "/placeholder-movie.jpg"
                  }
                  alt={m.title}
                  fill
                  priority
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link href={`/movie/${m.id}`}>
                        <Button
                          size="lg"
                          variant="outline"
                          className="border-white/80 text-white bg-black/20 backdrop-blur-sm hover:bg-white hover:text-black hover:border-white"
                        >
                          More Info
                        </Button>
                      </Link>
