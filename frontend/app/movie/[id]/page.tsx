...
function DesktopMovieDetailPage({ params }: { params: { id: string } }) {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
        ...
        {movie.news_reviews && movie.news_reviews.length > 0 && (
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {movie.news_reviews.slice(0, 3).map((item: any, index: number) => (
        ...
        {movie.movie_songs && movie.movie_songs.length > 0 && (
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {movie.movie_songs.slice(0, 3).map((song: any, index: number) => (
                <div key={index} className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors">
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <h4 className="font-semibold text-foreground text-sm line-clamp-2">
        ...
        {movie.gallery_images && movie.gallery_images.length > 0 && (
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {movie.gallery_images.slice(0, 8).map((image: any, index: number) => (
                <div key={index} className="group relative aspect-[3/4] bg-muted rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300">
                  {image.image_url ? (
                    <Image
                      src={image.image_url}
